        ...
        <Row>
          <Col lg='4' className='mb-4' md='6'>
            ...
            <p className='footer__text mt-4'>
              ...
              nesciunt temporibus obcaecati asperiores iusto autem consequuntur
              vero esse veniam maiores?
            </p>
          </Col>
            ...
            <div className='footer__quick-links'>
              ...
              <ListGroup className='footer__contact'>
                <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-2'>
                  ...
                  <p>7 Avenue Victor Hugo, Paris, France</p>
                </ListGroupItem>
          ...
          <Col lg='12'>
            <p className='footer__copyright'>
              Copyright {year} developed by Ryan Maziano. All rights reserved
            </p>
          </Col>
        </Row>
      </Container>
